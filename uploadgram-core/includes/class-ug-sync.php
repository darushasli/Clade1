...
class UG_Sync {
    ...
    public function render(): void {
        ...
        <div class="wrap">
            ...
            <p class="description"><?php esc_html_e( 'همهٔ صفحات اصلی (خانهٔ روی آدرس اصلی، خدمات مجازی، اکانت پرمیوم، شماره مجازی، ورود/ثبت‌نام، پنل کاربری) را برای ویرایش با المنتور آماده می‌کند. امن است: صفحه‌ای که از قبل با المنتور ساخته شده دست‌نخورده می‌ماند. نیاز به المنتور فعال. (صفحات متنی مثل سوالات/قوانین از همان دکمهٔ «ویرایش با المنتور» خودشان قابل‌ویرایش‌اند.)', 'uploadgram-core' ); ?></p>
            <p>
