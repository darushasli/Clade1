 ...
 * Edit freely — keep answers concise and keyword-rich for SEO.
 */
function ug_faq_schema_items() {
    return [
        [ 'خرید ممبر تلگرام از آپلودگرام چقدر طول می‌کشد؟', 'پس از ثبت سفارش و افزودن ربات بررسی به‌عنوان ادمین کانال، ممبرگیری معمولاً از چند دقیقه تا چند ساعت انجام می‌شود و وضعیت آن در پنل کاربری قابل پیگیری است.' ],
        [ 'آیا اکانت‌های پرمیوم اصل و قانونی هستند؟', 'بله، تمام اکانت‌های پرمیوم مانند ChatGPT Plus، اسپاتیفای، نتفلیکس و… اصل و با ضمانت تهیه می‌شوند و در صورت بروز مشکل در بازهٔ ضمانت، رایگان جایگزین می‌شوند.' ],
        [ 'شماره مجازی چطور کار می‌کند و برای چه سرویس‌هایی مناسب است؟', 'شماره مجازی را از پنل خریداری می‌کنید، در سرویس موردنظر (مثل تلگرام، واتساپ یا ChatGPT) وارد می‌کنید و کد تأیید به‌صورت خودکار در پنل نمایش داده می‌شود. مناسب ثبت‌نام و دریافت کد یکبارمصرف است.' ],
        [ 'روش‌های پرداخت در آپلودگرام چیست؟', 'می‌توانید کیف پول خود را شارژ کرده و از آن پرداخت کنید، یا برای اکانت‌های پرمیوم مستقیماً از درگاه پرداخت آنلاین استفاده کنید.' ],
        [ 'اگر سفارش من انجام نشد چه اتفاقی می‌افتد؟', 'در صورت عدم انجام سفارش، مبلغ به‌صورت خودکار به کیف پول شما بازگردانده می‌شود و از طریق تیکت پشتیبانی نیز می‌توانید پیگیری کنید.' ],
        [ 'آیا برای خرید ممبر به رمز عبور کانال نیاز است؟', 'خیر، برای هیچ سرویسی رمز عبور شما را نمی‌خواهیم؛ تنها لینک یا یوزرنیم عمومی کانال/پیج کافی است.' ],
    ];
}
