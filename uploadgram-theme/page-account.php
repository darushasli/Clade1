...
<div class="container">
  ...
  <div class="featured-grid" style="grid-template-columns:repeat(2,1fr);margin-bottom:14px;">
    <a class="feat-card" href="#" style="--fc:rgba(255,0,0,.18);min-height:104px;">
      <div class="feat-icon"><img src="<?php echo esc_url( ug_asset( 'iconpack/youtube.svg' ) ); ?>" alt=""></div>
      <div class="feat-text"><span class="feat-card-title">یوتیوب پرمیوم</span><span class="feat-card-link">اشتراک اصلی ←</span></div>
    </a>
    <a class="feat-card" href="#" style="--fc:rgba(29,185,84,.18);min-height:104px;">
      <div class="feat-icon"><img src="<?php echo esc_url( ug_asset( 'iconpack/spotify.svg' ) ); ?>" alt=""></div>
      <div class="feat-text"><span class="feat-card-title">اسپاتیفای پرمیوم</span><span class="feat-card-link">اکانت اورجینال ←</span></div>
    </a>
  </div>
  <div class="featured-grid" style="grid-template-columns:repeat(4,1fr);margin-bottom:24px;">
    <a class="feat-card" href="#" style="--fc:rgba(249,115,22,.16);">
      <div class="feat-icon"><img src="<?php echo esc_url( ug_asset( 'ai/midjourney.svg' ) ); ?>" alt=""></div>
      <div class="feat-text"><span class="feat-card-title">میدجرنی</span></div>
    </a>
    <a class="feat-card" href="#" style="--fc:rgba(10,102,194,.20);">
      <div class="feat-icon"><img src="<?php echo esc_url( ug_asset( 'iconpack/linkedin.svg' ) ); ?>" alt=""></div>
      <div class="feat-text"><span class="feat-card-title">لینکدین</span></div>
    </a>
    <a class="feat-card" href="#" style="--fc:rgba(139,92,246,.18);">
      <div class="feat-icon"><img src="<?php echo esc_url( ug_asset( 'new/canva-icon.svg' ) ); ?>" alt=""></div>
      <div class="feat-text"><span class="feat-card-title">کانوا پرو</span></div>
    </a>
    <a class="feat-card" href="#" style="--fc:rgba(16,163,127,.18);">
      <div class="feat-icon"><img src="<?php echo esc_url( ug_asset( 'ai/chatgpt.svg' ) ); ?>" alt=""></div>
      <div class="feat-text"><span class="feat-card-title">ChatGPT Plus</span></div>
    </a>
  </div>
